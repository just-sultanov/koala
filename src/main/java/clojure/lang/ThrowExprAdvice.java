...
public final class ThrowExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("throw-expr/enter");
  public final static Keyword onExit = Keyword.intern("throw-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(ThrowExpr.class)
        .visit(Advice.to(ThrowExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(ThrowExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.Origin("#m") String method,
      @Advice.This ThrowExpr expr,
