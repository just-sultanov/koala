...
public final class MapExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("map-expr/enter");
  public final static Keyword onExit = Keyword.intern("map-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(MapExpr.class)
        .visit(Advice.to(MapExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(MapExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.Origin("#m") String method,
      @Advice.This MapExpr expr,
