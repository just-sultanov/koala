...
public final class ImportExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("import-expr/enter");
  public final static Keyword onExit = Keyword.intern("import-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(ImportExpr.class)
        .visit(Advice.to(ImportExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(ImportExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.Origin("#m") String method,
      @Advice.This ImportExpr expr,
