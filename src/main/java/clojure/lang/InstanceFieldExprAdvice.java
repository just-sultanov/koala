...
public final class InstanceFieldExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("instance-field-expr/enter");
  public final static Keyword onExit = Keyword.intern("instance-field-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(InstanceFieldExpr.class)
        .visit(Advice.to(InstanceFieldExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(InstanceFieldExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.Origin("#m") String method,
      @Advice.This InstanceFieldExpr expr,
