...
public final class DefExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("def-expr/enter");
  public final static Keyword onExit = Keyword.intern("def-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(DefExpr.class)
        .visit(Advice.to(DefExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(DefExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.This DefExpr expr,
