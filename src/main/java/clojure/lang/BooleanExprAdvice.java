...
public final class BooleanExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("boolean-expr/enter");
  public final static Keyword onExit = Keyword.intern("boolean-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(BooleanExpr.class)
        .visit(Advice.to(BooleanExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(BooleanExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.Origin("#m") String method,
      @Advice.This BooleanExpr expr,
