...
public final class RecurExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("recur-expr/enter");
  public final static Keyword onExit = Keyword.intern("recur-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(RecurExpr.class)
        .visit(Advice.to(RecurExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(RecurExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.This RecurExpr expr,
