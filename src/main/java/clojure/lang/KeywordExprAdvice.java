...
public final class KeywordExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("keyword-expr/enter");
  public final static Keyword onExit = Keyword.intern("keyword-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(KeywordExpr.class)
        .visit(Advice.to(KeywordExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(KeywordExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.This KeywordExpr expr,
