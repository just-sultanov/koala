...
public final class ConstantExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("constant-expr/enter");
  public final static Keyword onExit = Keyword.intern("constant-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(ConstantExpr.class)
        .visit(Advice.to(ConstantExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(ConstantExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.Origin("#m") String method,
      @Advice.This ConstantExpr expr,
