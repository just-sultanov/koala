...
public final class EmptyExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("empty-expr/enter");
  public final static Keyword onExit = Keyword.intern("empty-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(EmptyExpr.class)
        .visit(Advice.to(EmptyExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(EmptyExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.This EmptyExpr expr,
