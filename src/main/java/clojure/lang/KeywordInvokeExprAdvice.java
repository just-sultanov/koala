...
public final class KeywordInvokeExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("keyword-invoke-expr/enter");
  public final static Keyword onExit = Keyword.intern("keyword-invoke-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(KeywordInvokeExpr.class)
        .visit(Advice.to(KeywordInvokeExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(KeywordInvokeExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.Origin("#m") String method,
      @Advice.This KeywordInvokeExpr expr,
