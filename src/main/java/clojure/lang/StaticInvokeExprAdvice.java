...
public final class StaticInvokeExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("static-invoke-expr/enter");
  public final static Keyword onExit = Keyword.intern("static-invoke-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(StaticInvokeExpr.class)
        .visit(Advice.to(StaticInvokeExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(StaticInvokeExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.This StaticInvokeExpr expr,
