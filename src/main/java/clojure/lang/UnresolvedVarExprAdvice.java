...
public final class UnresolvedVarExprAdvice {
  public final static IFn handler;
  public final static Keyword onEnter = Keyword.intern("unresolved-var-expr/enter");
  public final static Keyword onExit = Keyword.intern("unresolved-var-expr/exit");
  ...
  public static void instrument(final ClassReloadingStrategy strategy) {
    new ByteBuddy()
        .redefine(UnresolvedVarExpr.class)
        .visit(Advice.to(UnresolvedVarExprAdvice.class)
            .on(ElementMatchers.named("emit")
                .and(ElementMatchers.takesArguments(3))))
        .make()
        .load(UnresolvedVarExpr.class.getClassLoader(), strategy);
  }

  @Advice.OnMethodEnter
  public static void onMethodEnter(
      @Advice.Origin("#m") String method,
      @Advice.This UnresolvedVarExpr expr,
